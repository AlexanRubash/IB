...
static void Task2()
{
    ...
    string message = "Rubashek Alexandr Alexandrovich Rubashek Alexandr Alexandrovich Rubashek Alexandr Alexandrovich";
    ...
    Console.WriteLine("\nЭль-Гамаль");
    var plaintext = "Rubashek Alexandr Alexandrovich";
...
static void Task3()
{
    ...
    string message = "Rubashek Alexandr Alexandrovich";
